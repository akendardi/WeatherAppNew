...
import com.akendardi.weatherappnew.domain.usecase.GetForecastUseCase
import com.akendardi.weatherappnew.domain.usecase.ObserveFavouriteStateUseCase
import com.akendardi.weatherappnew.presentation.details.DetailsStore.Intent
import com.akendardi.weatherappnew.presentation.details.DetailsStore.Label
import com.akendardi.weatherappnew.presentation.details.DetailsStore.State
    ...
    private object ReducerImpl : Reducer<State, Msg> {
        override fun State.reduce(message: Msg): State = when (message) {
            is Msg.ForecastLoaded -> {
                copy(forecastState = State.ForecastState.Loaded(forecast = message.forecast))
            }
            ...
            is Msg.ForecastStatusChanged -> {
                copy(isFavourite = message.isFavourite)
            }
        }
    }
}
